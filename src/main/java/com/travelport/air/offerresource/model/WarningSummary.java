...
public class WarningSummary  implements Serializable  {
  ...
  public WarningSummary _atType(String _atType) {
  ...
  public WarningSummary statusCode(Integer statusCode) {
  ...
  public WarningSummary message(String message) {
  ...
  public WarningSummary nameValuePair(java.util.List<NameValuePair> nameValuePair) {
    this.nameValuePair = nameValuePair;
    return this;
  }

  public WarningSummary addNameValuePairItem(NameValuePair nameValuePairItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this._atType, warningSummary._atType) &&
        Objects.equals(this.statusCode, warningSummary.statusCode) &&
        Objects.equals(this.message, warningSummary.message) &&
        Objects.equals(this.nameValuePair, warningSummary.nameValuePair);
  }
