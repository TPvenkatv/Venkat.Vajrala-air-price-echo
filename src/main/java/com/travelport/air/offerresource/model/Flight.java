...
public class Flight extends FlightID implements Serializable  {
  ...
  public Flight stops(Integer stops) {
    this.stops = stops;
    return this;
  }
  ...
  public Flight duration(String duration) {
  ...
  public Flight carrier(String carrier) {
  ...
  public Flight operatingCarrier(String operatingCarrier) {
  ...
  public Flight operatingCarrierName(String operatingCarrierName) {
  ...
  public Flight equipment(String equipment) {
  ...
  public Flight departure(Departure departure) {
  ...
  public Flight arrival(Arrival arrival) {
  ...
  public Flight intermediateStop(java.util.List<IntermediateStop> intermediateStop) {
    this.intermediateStop = intermediateStop;
    return this;
  }

  public Flight addIntermediateStopItem(IntermediateStop intermediateStopItem) {
  ...
  public Flight subjectToGovernmentApprovalInd(Boolean subjectToGovernmentApprovalInd) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.distance, flight.distance) &&
        Objects.equals(this.stops, flight.stops) &&
        ...
        Objects.equals(this.operatingCarrierName, flight.operatingCarrierName) &&
        ...
        Objects.equals(this.intermediateStop, flight.intermediateStop) &&
        Objects.equals(this.subjectToGovernmentApprovalInd, flight.subjectToGovernmentApprovalInd) &&
        super.equals(o);
  }
