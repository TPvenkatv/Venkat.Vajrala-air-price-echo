...
@JsonSubTypes({
        @JsonSubTypes.Type(value = FeesDetail.class, name = "FeesDetail"),
})
...
public class Fees  implements Serializable  {
  ...
  public Fees _atType(String _atType) {
  ...
  public Fees totalFees(Float totalFees) {
  ...
  public boolean equals(Object o) {
    ...
    Fees fees = (Fees) o;
    return Objects.equals(this._atType, fees._atType) &&
        Objects.equals(this.totalFees, fees.totalFees);
  }
