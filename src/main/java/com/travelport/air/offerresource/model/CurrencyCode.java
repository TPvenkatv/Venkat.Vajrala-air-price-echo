 ...
 */
@Schema(description = "The currency code to which any conversion rates will apply")
@Validated
...
public class CurrencyCode  implements Serializable  {
  ...
  public CurrencyCode value(String value) {
    this.value = value;
    return this;
  }
  ...
  @Pattern(regexp="[a-zA-Z]{3}")   public String getValue() {
    return value;
  }
  ...
  public CurrencyCode codeAuthority(String codeAuthority) {
  ...
  public CurrencyCode decimalPlace(Integer decimalPlace) {
  ...
  public CurrencyCode decimalAuthority(String decimalAuthority) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.value, currencyCode.value) &&
        Objects.equals(this.codeAuthority, currencyCode.codeAuthority) &&
        Objects.equals(this.decimalPlace, currencyCode.decimalPlace) &&
        Objects.equals(this.decimalAuthority, currencyCode.decimalAuthority);
  }

  @Override
  public int hashCode() {
    return Objects.hash(value, codeAuthority, decimalPlace, decimalAuthority);
  }
