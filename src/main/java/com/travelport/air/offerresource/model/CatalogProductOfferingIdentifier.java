...
public class CatalogProductOfferingIdentifier  implements Serializable  {
  ...
  public CatalogProductOfferingIdentifier _atType(String _atType) {
  ...
  public CatalogProductOfferingIdentifier id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CatalogProductOfferingIdentifier identifier(Identifier identifier) {
  ...
  public CatalogProductOfferingIdentifier catalogProductOfferingRef(String catalogProductOfferingRef) {
  ...
  public boolean equals(Object o) {
    ...
    CatalogProductOfferingIdentifier catalogProductOfferingIdentifier = (CatalogProductOfferingIdentifier) o;
    return Objects.equals(this._atType, catalogProductOfferingIdentifier._atType) &&
        Objects.equals(this.id, catalogProductOfferingIdentifier.id) &&
        Objects.equals(this.identifier, catalogProductOfferingIdentifier.identifier) &&
        Objects.equals(this.catalogProductOfferingRef, catalogProductOfferingIdentifier.catalogProductOfferingRef);
  }
