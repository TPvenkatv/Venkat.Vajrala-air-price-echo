...
public class ArrivalFlight extends ArrivalFlightID implements Serializable  {
  ...
  public ArrivalFlight distance(Integer distance) {
  ...
  public ArrivalFlight stops(Integer stops) {
    this.stops = stops;
    return this;
  }
  ...
  public ArrivalFlight carrier(String carrier) {
  ...
  public ArrivalFlight number(String number) {
    this.number = number;
    return this;
  }
  ...
  public ArrivalFlight operatingCarrier(String operatingCarrier) {
  ...
  public ArrivalFlight operatingCarrierName(String operatingCarrierName) {
  ...
  public ArrivalFlight equipment(String equipment) {
  ...
  public ArrivalFlight departure(Departure departure) {
  ...
  public ArrivalFlight arrival(Arrival arrival) {
  ...
  public ArrivalFlight intermediateStop(java.util.List<IntermediateStop> intermediateStop) {
    this.intermediateStop = intermediateStop;
    return this;
  }

  public ArrivalFlight addIntermediateStopItem(IntermediateStop intermediateStopItem) {
  ...
  public ArrivalFlight subjectToGovernmentApprovalInd(Boolean subjectToGovernmentApprovalInd) {
  ...
  public boolean equals(Object o) {
    ...
    ArrivalFlight arrivalFlight = (ArrivalFlight) o;
    return Objects.equals(this.distance, arrivalFlight.distance) &&
        Objects.equals(this.stops, arrivalFlight.stops) &&
        Objects.equals(this.duration, arrivalFlight.duration) &&
        Objects.equals(this.carrier, arrivalFlight.carrier) &&
        Objects.equals(this.number, arrivalFlight.number) &&
        Objects.equals(this.operatingCarrier, arrivalFlight.operatingCarrier) &&
        Objects.equals(this.operatingCarrierName, arrivalFlight.operatingCarrierName) &&
        Objects.equals(this.equipment, arrivalFlight.equipment) &&
        Objects.equals(this.departure, arrivalFlight.departure) &&
        Objects.equals(this.arrival, arrivalFlight.arrival) &&
        Objects.equals(this.intermediateStop, arrivalFlight.intermediateStop) &&
        Objects.equals(this.subjectToGovernmentApprovalInd, arrivalFlight.subjectToGovernmentApprovalInd) &&
        super.equals(o);
  }
