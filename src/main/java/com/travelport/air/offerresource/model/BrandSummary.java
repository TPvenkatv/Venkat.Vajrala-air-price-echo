...
public class BrandSummary extends BrandID implements Serializable  {
  ...
  public BrandSummary name(String name) {
    this.name = name;
    return this;
  }
  ...
  public BrandSummary tier(Integer tier) {
    this.tier = tier;
    return this;
  }
  ...
  public BrandSummary shelfNumbers(java.util.List<Integer> shelfNumbers) {
    this.shelfNumbers = shelfNumbers;
    return this;
  }

  public BrandSummary addShelfNumbersItem(Integer shelfNumbersItem) {
  ...
  public BrandSummary brandAttribute(java.util.List<BrandAttribute> brandAttribute) {
    this.brandAttribute = brandAttribute;
    return this;
  }

  public BrandSummary addBrandAttributeItem(BrandAttribute brandAttributeItem) {
  ...
  public BrandSummary additionalBrandAttribute(java.util.List<AdditionalBrandAttribute> additionalBrandAttribute) {
    this.additionalBrandAttribute = additionalBrandAttribute;
    return this;
  }

  public BrandSummary addAdditionalBrandAttributeItem(AdditionalBrandAttribute additionalBrandAttributeItem) {
  ...
  public BrandSummary imageURL(java.util.List<String> imageURL) {
    this.imageURL = imageURL;
    return this;
  }

  public BrandSummary addImageURLItem(String imageURLItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, brandSummary.name) &&
        Objects.equals(this.tier, brandSummary.tier) &&
        Objects.equals(this.shelfNumbers, brandSummary.shelfNumbers) &&
        Objects.equals(this.brandAttribute, brandSummary.brandAttribute) &&
        Objects.equals(this.additionalBrandAttribute, brandSummary.additionalBrandAttribute) &&
        Objects.equals(this.imageURL, brandSummary.imageURL) &&
        super.equals(o);
  }
