...
public class EarnedCommissionPercent extends EarnedCommission implements Serializable  {
  private static final long serialVersionUID = 1L;

  @JsonProperty("Percent")
  private Float percent = null;

  public EarnedCommissionPercent percent(Float percent) {
  ...
  public boolean equals(Object o) {
    ...
    EarnedCommissionPercent earnedCommissionPercent = (EarnedCommissionPercent) o;
    return Objects.equals(this.percent, earnedCommissionPercent.percent) &&
        super.equals(o);
  }
