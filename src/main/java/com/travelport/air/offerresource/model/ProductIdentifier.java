...
public class ProductIdentifier  implements Serializable  {
  ...
  public ProductIdentifier _atType(String _atType) {
  ...
  public ProductIdentifier id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ProductIdentifier productRef(String productRef) {
  ...
  public ProductIdentifier identifier(Identifier identifier) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this._atType, productIdentifier._atType) &&
        Objects.equals(this.id, productIdentifier.id) &&
        Objects.equals(this.productRef, productIdentifier.productRef) &&
        Objects.equals(this.identifier, productIdentifier.identifier);
  }
