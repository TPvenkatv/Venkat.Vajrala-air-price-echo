...
public class ProductOptions extends ProductOptionsID implements Serializable  {
  ...
  public ProductOptions sequence(Integer sequence) {
  ...
  public ProductOptions product(java.util.List<ProductID> product) {
    this.product = product;
    return this;
  }

  public ProductOptions addProductItem(ProductID productItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sequence, productOptions.sequence) &&
        Objects.equals(this.product, productOptions.product) &&
        super.equals(o);
  }
