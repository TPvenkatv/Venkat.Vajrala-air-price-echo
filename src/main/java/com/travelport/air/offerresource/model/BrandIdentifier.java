...
public class BrandIdentifier  implements Serializable  {
  ...
  public BrandIdentifier _atType(String _atType) {
  ...
  public BrandIdentifier id(String id) {
    this.id = id;
    return this;
  }
  ...
  public BrandIdentifier brandRef(String brandRef) {
  ...
  public BrandIdentifier identifier(Identifier identifier) {
  ...
  public boolean equals(Object o) {
    ...
    BrandIdentifier brandIdentifier = (BrandIdentifier) o;
    return Objects.equals(this._atType, brandIdentifier._atType) &&
        Objects.equals(this.id, brandIdentifier.id) &&
        Objects.equals(this.brandRef, brandIdentifier.brandRef) &&
        Objects.equals(this.identifier, brandIdentifier.identifier);
  }
