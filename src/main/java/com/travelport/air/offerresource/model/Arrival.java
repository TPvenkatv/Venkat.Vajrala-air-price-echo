...
@JsonSubTypes({
        @JsonSubTypes.Type(value = ArrivalDetail.class, name = "ArrivalDetail"),
})
...
public class Arrival  implements Serializable  {
  ...
  public Arrival _atType(String _atType) {
  ...
  public Arrival location(String location) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this._atType, arrival._atType) &&
        Objects.equals(this.location, arrival.location) &&
