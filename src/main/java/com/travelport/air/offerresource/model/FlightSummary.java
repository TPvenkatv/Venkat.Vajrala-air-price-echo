...
public class FlightSummary extends FlightID implements Serializable  {
  ...
  public FlightSummary distance(Integer distance) {
  ...
  public FlightSummary stops(Integer stops) {
    this.stops = stops;
    return this;
  }
  ...
  public FlightSummary duration(String duration) {
  ...
  public FlightSummary carrier(String carrier) {
  ...
  public FlightSummary number(String number) {
    this.number = number;
    return this;
  }
  ...
  public FlightSummary operatingCarrier(String operatingCarrier) {
  ...
  public FlightSummary operatingCarrierName(String operatingCarrierName) {
  ...
  public FlightSummary equipment(String equipment) {
  ...
  public FlightSummary departure(Departure departure) {
  ...
  public FlightSummary arrival(Arrival arrival) {
  ...
  public FlightSummary intermediateStop(java.util.List<IntermediateStop> intermediateStop) {
    this.intermediateStop = intermediateStop;
    return this;
  }

  public FlightSummary addIntermediateStopItem(IntermediateStop intermediateStopItem) {
  ...
  public FlightSummary subjectToGovernmentApprovalInd(Boolean subjectToGovernmentApprovalInd) {
  ...
  public boolean equals(Object o) {
    ...
    FlightSummary flightSummary = (FlightSummary) o;
    return Objects.equals(this.distance, flightSummary.distance) &&
        Objects.equals(this.stops, flightSummary.stops) &&
        Objects.equals(this.duration, flightSummary.duration) &&
        Objects.equals(this.carrier, flightSummary.carrier) &&
        Objects.equals(this.number, flightSummary.number) &&
        Objects.equals(this.operatingCarrier, flightSummary.operatingCarrier) &&
        Objects.equals(this.operatingCarrierName, flightSummary.operatingCarrierName) &&
        Objects.equals(this.equipment, flightSummary.equipment) &&
        Objects.equals(this.departure, flightSummary.departure) &&
        Objects.equals(this.arrival, flightSummary.arrival) &&
        Objects.equals(this.intermediateStop, flightSummary.intermediateStop) &&
        Objects.equals(this.subjectToGovernmentApprovalInd, flightSummary.subjectToGovernmentApprovalInd) &&
        super.equals(o);
  }
