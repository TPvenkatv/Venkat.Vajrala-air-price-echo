...
public class ErrorWarningSummary  implements Serializable  {
  ...
  public ErrorWarningSummary _atType(String _atType) {
  ...
  public ErrorWarningSummary statusCode(Integer statusCode) {
  ...
  public ErrorWarningSummary message(String message) {
  ...
  public ErrorWarningSummary nameValuePair(java.util.List<NameValuePair> nameValuePair) {
    this.nameValuePair = nameValuePair;
    return this;
  }

  public ErrorWarningSummary addNameValuePairItem(NameValuePair nameValuePairItem) {
  ...
  public boolean equals(Object o) {
    ...
    ErrorWarningSummary errorWarningSummary = (ErrorWarningSummary) o;
    return Objects.equals(this._atType, errorWarningSummary._atType) &&
        Objects.equals(this.statusCode, errorWarningSummary.statusCode) &&
        Objects.equals(this.message, errorWarningSummary.message) &&
        Objects.equals(this.nameValuePair, errorWarningSummary.nameValuePair);
  }
