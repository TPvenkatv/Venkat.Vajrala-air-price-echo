...
@JsonSubTypes({
        @JsonSubTypes.Type(value = AttributeTextDetail.class, name = "AttributeTextDetail"),
})


public class AttributeText  implements Serializable  {
  ...
  public AttributeText _atType(String _atType) {
  ...
  public AttributeText id(String id) {
    this.id = id;
    return this;
  }
  ...
  public AttributeText target(BrandTargetEnum target) {
    this.target = target;
    return this;
  }
  ...
  public AttributeText textFormatted(java.util.List<TextFormatted> textFormatted) {
    this.textFormatted = textFormatted;
    return this;
  }

  public AttributeText addTextFormattedItem(TextFormatted textFormattedItem) {
  ...
  public boolean equals(Object o) {
    ...
    AttributeText attributeText = (AttributeText) o;
    return Objects.equals(this._atType, attributeText._atType) &&
        Objects.equals(this.id, attributeText.id) &&
        Objects.equals(this.target, attributeText.target) &&
        Objects.equals(this.textFormatted, attributeText.textFormatted);
  }
