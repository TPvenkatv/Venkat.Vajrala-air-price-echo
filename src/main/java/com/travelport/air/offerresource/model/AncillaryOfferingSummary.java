...
public class AncillaryOfferingSummary extends AncillaryOfferingID implements Serializable  {
  ...
  public AncillaryOfferingSummary productRefs(java.util.List<String> productRefs) {
    this.productRefs = productRefs;
    return this;
  }

  public AncillaryOfferingSummary addProductRefsItem(String productRefsItem) {
  ...
  public AncillaryOfferingSummary productOptions(java.util.List<ProductOptionsID> productOptions) {
    this.productOptions = productOptions;
    return this;
  }

  public AncillaryOfferingSummary addProductOptionsItem(ProductOptionsID productOptionsItem) {
  ...
  public AncillaryOfferingSummary price(Price price) {
    this.price = price;
    return this;
  }
  ...
  public AncillaryOfferingSummary termsAndConditions(TermsAndConditionsID termsAndConditions) {
  ...
  public boolean equals(Object o) {
    ...
    AncillaryOfferingSummary ancillaryOfferingSummary = (AncillaryOfferingSummary) o;
    return Objects.equals(this.productRefs, ancillaryOfferingSummary.productRefs) &&
        Objects.equals(this.productOptions, ancillaryOfferingSummary.productOptions) &&
        Objects.equals(this.price, ancillaryOfferingSummary.price) &&
        Objects.equals(this.termsAndConditions, ancillaryOfferingSummary.termsAndConditions) &&
        super.equals(o);
  }
