...
import com.travelport.air.offerresource.model.RateDescription;
...
public class RateDescriptionDetail extends RateDescription implements Serializable  {
  ...
  public RateDescriptionDetail sequence(Integer sequence) {
  ...
  public RateDescriptionDetail description(String description) {
  ...
  public RateDescriptionDetail image(Image image) {
    this.image = image;
    return this;
  }
  ...
  public RateDescriptionDetail URL(String URL) {
    this.URL = URL;
    return this;
  }
  ...
  public RateDescriptionDetail dateCreateModify(DateCreateModify dateCreateModify) {
  ...
  public boolean equals(Object o) {
    ...
    RateDescriptionDetail rateDescriptionDetail = (RateDescriptionDetail) o;
    return Objects.equals(this.sequence, rateDescriptionDetail.sequence) &&
        Objects.equals(this.description, rateDescriptionDetail.description) &&
        Objects.equals(this.image, rateDescriptionDetail.image) &&
        Objects.equals(this.URL, rateDescriptionDetail.URL) &&
        Objects.equals(this.dateCreateModify, rateDescriptionDetail.dateCreateModify) &&
        super.equals(o);
  }
