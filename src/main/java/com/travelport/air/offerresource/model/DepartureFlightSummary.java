...
public class DepartureFlightSummary extends DepartureFlightID implements Serializable  {
  ...
  public DepartureFlightSummary distance(Integer distance) {
  ...
  public DepartureFlightSummary stops(Integer stops) {
    this.stops = stops;
    return this;
  }
  ...
  public DepartureFlightSummary duration(String duration) {
  ...
  public DepartureFlightSummary carrier(String carrier) {
  ...
  public DepartureFlightSummary number(String number) {
    this.number = number;
    return this;
  }
  ...
  public DepartureFlightSummary operatingCarrier(String operatingCarrier) {
  ...
  public DepartureFlightSummary operatingCarrierName(String operatingCarrierName) {
  ...
  public DepartureFlightSummary equipment(String equipment) {
  ...
  public DepartureFlightSummary departure(Departure departure) {
  ...
  public DepartureFlightSummary arrival(Arrival arrival) {
  ...
  public DepartureFlightSummary intermediateStop(java.util.List<IntermediateStop> intermediateStop) {
    this.intermediateStop = intermediateStop;
    return this;
  }

  public DepartureFlightSummary addIntermediateStopItem(IntermediateStop intermediateStopItem) {
  ...
  public DepartureFlightSummary subjectToGovernmentApprovalInd(Boolean subjectToGovernmentApprovalInd) {
  ...
  public boolean equals(Object o) {
    ...
    DepartureFlightSummary departureFlightSummary = (DepartureFlightSummary) o;
    return Objects.equals(this.distance, departureFlightSummary.distance) &&
        Objects.equals(this.stops, departureFlightSummary.stops) &&
        Objects.equals(this.duration, departureFlightSummary.duration) &&
        Objects.equals(this.carrier, departureFlightSummary.carrier) &&
        Objects.equals(this.number, departureFlightSummary.number) &&
        Objects.equals(this.operatingCarrier, departureFlightSummary.operatingCarrier) &&
        Objects.equals(this.operatingCarrierName, departureFlightSummary.operatingCarrierName) &&
        Objects.equals(this.equipment, departureFlightSummary.equipment) &&
        Objects.equals(this.departure, departureFlightSummary.departure) &&
        Objects.equals(this.arrival, departureFlightSummary.arrival) &&
        Objects.equals(this.intermediateStop, departureFlightSummary.intermediateStop) &&
        Objects.equals(this.subjectToGovernmentApprovalInd, departureFlightSummary.subjectToGovernmentApprovalInd) &&
        super.equals(o);
  }
