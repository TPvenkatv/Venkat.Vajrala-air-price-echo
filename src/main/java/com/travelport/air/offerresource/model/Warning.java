...
@JsonSubTypes({
        @JsonSubTypes.Type(value = WarningDetail.class, name = "WarningDetail"),
})
...
public class Warning  implements Serializable  {
  ...
  public Warning _atType(String _atType) {
  ...
  public Warning statusCode(Integer statusCode) {
  ...
  public Warning nameValuePair(java.util.List<NameValuePair> nameValuePair) {
    this.nameValuePair = nameValuePair;
    return this;
  }

  public Warning addNameValuePairItem(NameValuePair nameValuePairItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this._atType, warning._atType) &&
        Objects.equals(this.statusCode, warning.statusCode) &&
        Objects.equals(this.message, warning.message) &&
        Objects.equals(this.nameValuePair, warning.nameValuePair);
  }
