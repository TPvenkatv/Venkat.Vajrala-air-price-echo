...
@JsonSubTypes({
        @JsonSubTypes.Type(value = PricingModifiersAirDetail.class, name = "PricingModifiersAirDetail"),
})


public class PricingModifiersAir  implements Serializable  {
  ...
  public PricingModifiersAir _atType(String _atType) {
  ...
  public PricingModifiersAir currencyCode(String currencyCode) {
  ...
  public PricingModifiersAir fareSelection(FareSelection fareSelection) {
  ...
  public PricingModifiersAir organizationInformation(OrganizationInformation organizationInformation) {
  ...
  public PricingModifiersAir taxExemption(TaxExemption taxExemption) {
  ...
  public PricingModifiersAir promotionalCode(java.util.List<PromotionalCode> promotionalCode) {
    this.promotionalCode = promotionalCode;
    return this;
  }

  public PricingModifiersAir addPromotionalCodeItem(PromotionalCode promotionalCodeItem) {
  ...
  public PricingModifiersAir sellCity(String sellCity) {
  ...
  public PricingModifiersAir ticketCity(String ticketCity) {
  ...
  public PricingModifiersAir includeSplitPaymentInd(Boolean includeSplitPaymentInd) {
  ...
  public boolean equals(Object o) {
    ...
    PricingModifiersAir pricingModifiersAir = (PricingModifiersAir) o;
    return Objects.equals(this._atType, pricingModifiersAir._atType) &&
        Objects.equals(this.currencyCode, pricingModifiersAir.currencyCode) &&
        Objects.equals(this.fareSelection, pricingModifiersAir.fareSelection) &&
        Objects.equals(this.organizationInformation, pricingModifiersAir.organizationInformation) &&
        Objects.equals(this.taxExemption, pricingModifiersAir.taxExemption) &&
        Objects.equals(this.promotionalCode, pricingModifiersAir.promotionalCode) &&
        Objects.equals(this.sellCity, pricingModifiersAir.sellCity) &&
        Objects.equals(this.ticketCity, pricingModifiersAir.ticketCity) &&
        Objects.equals(this.includeSplitPaymentInd, pricingModifiersAir.includeSplitPaymentInd);
  }
