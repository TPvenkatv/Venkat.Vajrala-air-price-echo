...
public class VendorCurrencyTotal  implements Serializable  {
  ...
  public VendorCurrencyTotal _atType(String _atType) {
  ...
  public VendorCurrencyTotal currencySource(CurrencySourceEnum currencySource) {
  ...
  public VendorCurrencyTotal currencyCode(CurrencyCode currencyCode) {
  ...
  public VendorCurrencyTotal base(Float base) {
    this.base = base;
    return this;
  }
  ...
  public VendorCurrencyTotal taxes(Taxes taxes) {
    this.taxes = taxes;
    return this;
  }
  ...
  public VendorCurrencyTotal fees(Fees fees) {
    this.fees = fees;
    return this;
  }
  ...
  public VendorCurrencyTotal total(Float total) {
    this.total = total;
    return this;
  }
  ...
  public VendorCurrencyTotal approximateInd(Boolean approximateInd) {
  ...
  public boolean equals(Object o) {
    ...
    VendorCurrencyTotal vendorCurrencyTotal = (VendorCurrencyTotal) o;
    return Objects.equals(this._atType, vendorCurrencyTotal._atType) &&
        Objects.equals(this.currencySource, vendorCurrencyTotal.currencySource) &&
        Objects.equals(this.currencyCode, vendorCurrencyTotal.currencyCode) &&
        Objects.equals(this.base, vendorCurrencyTotal.base) &&
        Objects.equals(this.taxes, vendorCurrencyTotal.taxes) &&
        Objects.equals(this.fees, vendorCurrencyTotal.fees) &&
        Objects.equals(this.total, vendorCurrencyTotal.total) &&
        Objects.equals(this.approximateInd, vendorCurrencyTotal.approximateInd);
  }
