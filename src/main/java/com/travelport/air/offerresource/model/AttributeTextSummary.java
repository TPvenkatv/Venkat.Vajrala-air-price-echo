...
public class AttributeTextSummary  implements Serializable  {
  ...
  public AttributeTextSummary _atType(String _atType) {
  ...
  public AttributeTextSummary id(String id) {
    this.id = id;
    return this;
  }
  ...
  public AttributeTextSummary target(BrandTargetEnum target) {
    this.target = target;
    return this;
  }
  ...
  public AttributeTextSummary textFormatted(java.util.List<TextFormatted> textFormatted) {
    this.textFormatted = textFormatted;
    return this;
  }

  public AttributeTextSummary addTextFormattedItem(TextFormatted textFormattedItem) {
  ...
  public boolean equals(Object o) {
    ...
    AttributeTextSummary attributeTextSummary = (AttributeTextSummary) o;
    return Objects.equals(this._atType, attributeTextSummary._atType) &&
        Objects.equals(this.id, attributeTextSummary.id) &&
        Objects.equals(this.target, attributeTextSummary.target) &&
        Objects.equals(this.textFormatted, attributeTextSummary.textFormatted);
  }
