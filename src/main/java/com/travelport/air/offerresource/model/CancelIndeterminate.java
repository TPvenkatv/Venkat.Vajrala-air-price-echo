...
public class CancelIndeterminate extends Cancel implements Serializable  {
  private static final long serialVersionUID = 1L;

  @JsonProperty("IndeterminateInd")
  private Boolean indeterminateInd = null;

  public CancelIndeterminate indeterminateInd(Boolean indeterminateInd) {
  ...
  public boolean equals(Object o) {
    ...
    CancelIndeterminate cancelIndeterminate = (CancelIndeterminate) o;
    return Objects.equals(this.indeterminateInd, cancelIndeterminate.indeterminateInd) &&
        super.equals(o);
  }
