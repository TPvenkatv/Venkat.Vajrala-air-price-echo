...
public class ArrivalFlightDetail extends ArrivalFlightID implements Serializable  {
  private static final long serialVersionUID = 1L;

  @JsonProperty("AvailabilitySourceCode")
  private AvailabilitySourceCodeENUM availabilitySourceCode = null;

  public ArrivalFlightDetail availabilitySourceCode(AvailabilitySourceCodeENUM availabilitySourceCode) {
  ...
  public boolean equals(Object o) {
    ...
    ArrivalFlightDetail arrivalFlightDetail = (ArrivalFlightDetail) o;
    return Objects.equals(this.availabilitySourceCode, arrivalFlightDetail.availabilitySourceCode) &&
        super.equals(o);
  }
