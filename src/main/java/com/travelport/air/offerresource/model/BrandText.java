...
@JsonSubTypes({
        @JsonSubTypes.Type(value = BrandTextDetail.class, name = "BrandTextDetail"),
})
...
public class BrandText  implements Serializable  {
  ...
  public BrandText _atType(String _atType) {
  ...
  public BrandText target(BrandTargetEnum target) {
    this.target = target;
    return this;
  }
  ...
  public BrandText textFormatted(java.util.List<TextFormatted> textFormatted) {
    this.textFormatted = textFormatted;
    return this;
  }

  public BrandText addTextFormattedItem(TextFormatted textFormattedItem) {
  ...
  public boolean equals(Object o) {
    ...
    BrandText brandText = (BrandText) o;
    return Objects.equals(this._atType, brandText._atType) &&
        Objects.equals(this.id, brandText.id) &&
        Objects.equals(this.target, brandText.target) &&
        Objects.equals(this.textFormatted, brandText.textFormatted);
  }
