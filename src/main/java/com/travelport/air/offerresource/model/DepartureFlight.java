...
public class DepartureFlight extends DepartureFlightID implements Serializable  {
  ...
  public DepartureFlight distance(Integer distance) {
  ...
  public DepartureFlight stops(Integer stops) {
    this.stops = stops;
    return this;
  }
  ...
  public DepartureFlight carrier(String carrier) {
  ...
  public DepartureFlight number(String number) {
    this.number = number;
    return this;
  }
  ...
  public DepartureFlight operatingCarrier(String operatingCarrier) {
  ...
  public DepartureFlight operatingCarrierName(String operatingCarrierName) {
  ...
  public DepartureFlight equipment(String equipment) {
  ...
  public DepartureFlight departure(Departure departure) {
  ...
  public DepartureFlight arrival(Arrival arrival) {
  ...
  public DepartureFlight intermediateStop(java.util.List<IntermediateStop> intermediateStop) {
    this.intermediateStop = intermediateStop;
    return this;
  }

  public DepartureFlight addIntermediateStopItem(IntermediateStop intermediateStopItem) {
  ...
  public DepartureFlight subjectToGovernmentApprovalInd(Boolean subjectToGovernmentApprovalInd) {
  ...
  public boolean equals(Object o) {
    ...
    DepartureFlight departureFlight = (DepartureFlight) o;
    return Objects.equals(this.distance, departureFlight.distance) &&
        Objects.equals(this.stops, departureFlight.stops) &&
        Objects.equals(this.duration, departureFlight.duration) &&
        Objects.equals(this.carrier, departureFlight.carrier) &&
        Objects.equals(this.number, departureFlight.number) &&
        Objects.equals(this.operatingCarrier, departureFlight.operatingCarrier) &&
        Objects.equals(this.operatingCarrierName, departureFlight.operatingCarrierName) &&
        Objects.equals(this.equipment, departureFlight.equipment) &&
        Objects.equals(this.departure, departureFlight.departure) &&
        Objects.equals(this.arrival, departureFlight.arrival) &&
        Objects.equals(this.intermediateStop, departureFlight.intermediateStop) &&
        Objects.equals(this.subjectToGovernmentApprovalInd, departureFlight.subjectToGovernmentApprovalInd) &&
        super.equals(o);
  }
