...
public class TextBlockSummary  implements Serializable  {
  ...
  public TextBlockSummary _atType(String _atType) {
  ...
  public TextBlockSummary title(String title) {
    this.title = title;
    return this;
  }
  ...
  public TextBlockSummary id(String id) {
    this.id = id;
    return this;
  }
  ...
  public TextBlockSummary textFormatted(java.util.List<TextFormatted> textFormatted) {
    this.textFormatted = textFormatted;
    return this;
  }

  public TextBlockSummary addTextFormattedItem(TextFormatted textFormattedItem) {
  ...
  public boolean equals(Object o) {
    ...
    TextBlockSummary textBlockSummary = (TextBlockSummary) o;
    return Objects.equals(this._atType, textBlockSummary._atType) &&
        Objects.equals(this.title, textBlockSummary.title) &&
        Objects.equals(this.id, textBlockSummary.id) &&
        Objects.equals(this.textFormatted, textBlockSummary.textFormatted);
  }
