...
public class UpsellOfferingIdentifier  implements Serializable  {
  ...
  public UpsellOfferingIdentifier _atType(String _atType) {
  ...
  public UpsellOfferingIdentifier id(String id) {
    this.id = id;
    return this;
  }
  ...
  public UpsellOfferingIdentifier identifier(Identifier identifier) {
  ...
  public UpsellOfferingIdentifier catalogProductOfferingRef(String catalogProductOfferingRef) {
  ...
  public boolean equals(Object o) {
    ...
    UpsellOfferingIdentifier upsellOfferingIdentifier = (UpsellOfferingIdentifier) o;
    return Objects.equals(this._atType, upsellOfferingIdentifier._atType) &&
        Objects.equals(this.id, upsellOfferingIdentifier.id) &&
        Objects.equals(this.identifier, upsellOfferingIdentifier.identifier) &&
        Objects.equals(this.catalogProductOfferingRef, upsellOfferingIdentifier.catalogProductOfferingRef);
  }
