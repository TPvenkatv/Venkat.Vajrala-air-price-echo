...
@JsonSubTypes({
        @JsonSubTypes.Type(value = DepartureDetail.class, name = "DepartureDetail"),
})
...
public class Departure  implements Serializable  {
  ...
  public Departure _atType(String _atType) {
  ...
  public Departure location(String location) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this._atType, departure._atType) &&
        Objects.equals(this.location, departure.location) &&
