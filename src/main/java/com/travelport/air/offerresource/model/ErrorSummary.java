...
public class ErrorSummary  implements Serializable  {
  ...
  public ErrorSummary _atType(String _atType) {
  ...
  public ErrorSummary statusCode(Integer statusCode) {
  ...
  public ErrorSummary message(String message) {
  ...
  public ErrorSummary nameValuePair(java.util.List<NameValuePair> nameValuePair) {
    this.nameValuePair = nameValuePair;
    return this;
  }

  public ErrorSummary addNameValuePairItem(NameValuePair nameValuePairItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this._atType, errorSummary._atType) &&
        Objects.equals(this.statusCode, errorSummary.statusCode) &&
        Objects.equals(this.message, errorSummary.message) &&
        Objects.equals(this.nameValuePair, errorSummary.nameValuePair);
  }
