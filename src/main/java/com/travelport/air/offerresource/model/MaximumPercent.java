...
public class MaximumPercent extends Maximum implements Serializable  {
  private static final long serialVersionUID = 1L;

  @JsonProperty("Percent")
  private Float percent = null;

  public MaximumPercent percent(Float percent) {
  ...
  public boolean equals(Object o) {
    ...
    MaximumPercent maximumPercent = (MaximumPercent) o;
    return Objects.equals(this.percent, maximumPercent.percent) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class MaximumPercent {\n");
