...
@JsonSubTypes({
        @JsonSubTypes.Type(value = TextBlockDetail.class, name = "TextBlockDetail"),
})
...
public class TextBlock  implements Serializable  {
  ...
  public TextBlock _atType(String _atType) {
  ...
  public TextBlock title(String title) {
    this.title = title;
    return this;
  }
  ...
  public TextBlock textFormatted(java.util.List<TextFormatted> textFormatted) {
    this.textFormatted = textFormatted;
    return this;
  }

  public TextBlock addTextFormattedItem(TextFormatted textFormattedItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this._atType, textBlock._atType) &&
        Objects.equals(this.title, textBlock.title) &&
        Objects.equals(this.id, textBlock.id) &&
        Objects.equals(this.textFormatted, textBlock.textFormatted);
  }
