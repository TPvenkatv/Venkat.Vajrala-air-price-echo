...
public class MaximumStayIndeterminate extends MaximumStay implements Serializable  {
  private static final long serialVersionUID = 1L;

  @JsonProperty("IndeterminateInd")
  private Boolean indeterminateInd = null;

  public MaximumStayIndeterminate indeterminateInd(Boolean indeterminateInd) {
  ...
  public boolean equals(Object o) {
    ...
    MaximumStayIndeterminate maximumStayIndeterminate = (MaximumStayIndeterminate) o;
    return Objects.equals(this.indeterminateInd, maximumStayIndeterminate.indeterminateInd) &&
        super.equals(o);
  }
