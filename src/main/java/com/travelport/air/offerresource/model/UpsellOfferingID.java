...
public class UpsellOfferingID  implements Serializable  {
  ...
  public UpsellOfferingID _atType(String _atType) {
  ...
  public UpsellOfferingID id(String id) {
    this.id = id;
    return this;
  }
  ...
  public UpsellOfferingID identifier(Identifier identifier) {
  ...
  public UpsellOfferingID catalogProductOfferingRef(String catalogProductOfferingRef) {
  ...
  public boolean equals(Object o) {
    ...
    UpsellOfferingID upsellOfferingID = (UpsellOfferingID) o;
    return Objects.equals(this._atType, upsellOfferingID._atType) &&
        Objects.equals(this.id, upsellOfferingID.id) &&
        Objects.equals(this.identifier, upsellOfferingID.identifier) &&
        Objects.equals(this.catalogProductOfferingRef, upsellOfferingID.catalogProductOfferingRef);
  }
