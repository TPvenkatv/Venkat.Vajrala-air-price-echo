...
public class MinimumPercent extends Minimum implements Serializable  {
  private static final long serialVersionUID = 1L;

  @JsonProperty("Percent")
  private Float percent = null;

  public MinimumPercent percent(Float percent) {
  ...
  public boolean equals(Object o) {
    ...
    MinimumPercent minimumPercent = (MinimumPercent) o;
    return Objects.equals(this.percent, minimumPercent.percent) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class MinimumPercent {\n");
