...
@JsonSubTypes({
        @JsonSubTypes.Type(value = AncillaryOfferingSummary.class, name = "AncillaryOfferingSummary"),
        @JsonSubTypes.Type(value = AncillaryOffering.class, name = "AncillaryOffering"),
})


public class AncillaryOfferingID  implements Serializable  {
  ...
  public AncillaryOfferingID _atType(String _atType) {
  ...
  public AncillaryOfferingID id(String id) {
    this.id = id;
    return this;
  }
  ...
  public AncillaryOfferingID catalogOfferingRef(String catalogOfferingRef) {
  ...
  public AncillaryOfferingID ancillaryOfferingRef(String ancillaryOfferingRef) {
  ...
  public AncillaryOfferingID identifier(Identifier identifier) {
  ...
  public boolean equals(Object o) {
    ...
    AncillaryOfferingID ancillaryOfferingID = (AncillaryOfferingID) o;
    return Objects.equals(this._atType, ancillaryOfferingID._atType) &&
        Objects.equals(this.id, ancillaryOfferingID.id) &&
        Objects.equals(this.catalogOfferingRef, ancillaryOfferingID.catalogOfferingRef) &&
        Objects.equals(this.ancillaryOfferingRef, ancillaryOfferingID.ancillaryOfferingRef) &&
        Objects.equals(this.identifier, ancillaryOfferingID.identifier);
  }
