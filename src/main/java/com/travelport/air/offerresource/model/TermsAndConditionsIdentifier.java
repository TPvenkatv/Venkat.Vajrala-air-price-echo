...
public class TermsAndConditionsIdentifier  implements Serializable  {
  ...
  public TermsAndConditionsIdentifier _atType(String _atType) {
  ...
  public TermsAndConditionsIdentifier id(String id) {
    this.id = id;
    return this;
  }
  ...
  public TermsAndConditionsIdentifier termsAndConditionsRef(String termsAndConditionsRef) {
  ...
  public TermsAndConditionsIdentifier identifier(Identifier identifier) {
  ...
  public boolean equals(Object o) {
    ...
    TermsAndConditionsIdentifier termsAndConditionsIdentifier = (TermsAndConditionsIdentifier) o;
    return Objects.equals(this._atType, termsAndConditionsIdentifier._atType) &&
        Objects.equals(this.id, termsAndConditionsIdentifier.id) &&
        Objects.equals(this.termsAndConditionsRef, termsAndConditionsIdentifier.termsAndConditionsRef) &&
        Objects.equals(this.identifier, termsAndConditionsIdentifier.identifier);
  }
