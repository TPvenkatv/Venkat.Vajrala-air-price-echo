...
@JsonSubTypes({
        @JsonSubTypes.Type(value = SurchargesDetail.class, name = "SurchargesDetail"),
})
...
public class Surcharges  implements Serializable  {
  ...
  public Surcharges _atType(String _atType) {
  ...
  public Surcharges totalSurcharges(Float totalSurcharges) {
  ...
  public Surcharges approximateInd(Boolean approximateInd) {
  ...
  public boolean equals(Object o) {
    ...
    Surcharges surcharges = (Surcharges) o;
    return Objects.equals(this._atType, surcharges._atType) &&
        Objects.equals(this.totalSurcharges, surcharges.totalSurcharges) &&
        Objects.equals(this.approximateInd, surcharges.approximateInd);
  }
