...
@JsonSubTypes({
        @JsonSubTypes.Type(value = ErrorWarningDetail.class, name = "ErrorWarningDetail"),
})


public class ErrorWarning  implements Serializable  {
  ...
  public ErrorWarning _atType(String _atType) {
  ...
  public ErrorWarning statusCode(Integer statusCode) {
  ...
  public ErrorWarning message(String message) {
  ...
  public ErrorWarning nameValuePair(java.util.List<NameValuePair> nameValuePair) {
    this.nameValuePair = nameValuePair;
    return this;
  }

  public ErrorWarning addNameValuePairItem(NameValuePair nameValuePairItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this._atType, errorWarning._atType) &&
        Objects.equals(this.statusCode, errorWarning.statusCode) &&
        Objects.equals(this.message, errorWarning.message) &&
        Objects.equals(this.nameValuePair, errorWarning.nameValuePair);
  }
