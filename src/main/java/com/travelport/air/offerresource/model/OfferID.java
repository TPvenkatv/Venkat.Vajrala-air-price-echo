...
@JsonSubTypes({
        @JsonSubTypes.Type(value = OfferSummary.class, name = "OfferSummary"),
        @JsonSubTypes.Type(value = Offer.class, name = "Offer"),
        @JsonSubTypes.Type(value = OfferUpsell.class, name = "OfferUpsell"),
})
...
public class OfferID  implements Serializable  {
  ...
  public OfferID _atType(String _atType) {
  ...
  public OfferID offerRef(String offerRef) {
  ...
  public OfferID identifier(Identifier identifier) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this._atType, offerID._atType) &&
        Objects.equals(this.id, offerID.id) &&
        Objects.equals(this.offerRef, offerID.offerRef) &&
        Objects.equals(this.identifier, offerID.identifier);
  }
