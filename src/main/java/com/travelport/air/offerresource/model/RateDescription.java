...
@JsonSubTypes({
        @JsonSubTypes.Type(value = RateDescriptionDetail.class, name = "RateDescriptionDetail"),
})


public class RateDescription  implements Serializable  {
  ...
  public RateDescription _atType(String _atType) {
  ...
  public RateDescription title(String title) {
    this.title = title;
    return this;
  }
  ...
  public RateDescription id(String id) {
    this.id = id;
    return this;
  }
  ...
  public RateDescription textFormatted(java.util.List<TextFormatted> textFormatted) {
    this.textFormatted = textFormatted;
    return this;
  }

  public RateDescription addTextFormattedItem(TextFormatted textFormattedItem) {
  ...
  public boolean equals(Object o) {
    ...
    RateDescription rateDescription = (RateDescription) o;
    return Objects.equals(this._atType, rateDescription._atType) &&
        Objects.equals(this.title, rateDescription.title) &&
        Objects.equals(this.id, rateDescription.id) &&
        Objects.equals(this.textFormatted, rateDescription.textFormatted);
  }
